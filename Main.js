...
for (var index=1; index<=10; index++) {
  var color = ("This is countdown" + index  );
 console.log(color)
...
function submit() {
    ...
    document.getElementById("App1.Show").style.display="inline-block";
...
document.getElementById("App1.Show").style.display="none";
}
 function app() {
  document.getElementById("Name").style.display="inline-block";
  ...
  function game() {
    document.getElementById("Name").style.display="inline-block";
    document.getElementById("appi1").style.display="table";
    document.getElementById("website.Show").style.display="none";
    document.getElementById("App.Show").style.display="none";
    document.getElementById("App1.Show").style.display="none";
}
